...
const phoneOthersDetails = (others) => {
  ...
  div.innerHTML = `
    ...
    <h6 style="margin-bottom:-1px;">Bluetooth: ${
      others.data.others?.Bluetooth
        ? others.data.others?.Bluetooth
        : "No Bluetooth"
    }</h6>
    <h6 style="margin-bottom:-1px;">GPS: ${
      others.data.others?.GPS ? others.data.others?.GPS : "No GPS"
    }</h6>
    <h6 style="margin-bottom:-1px;">NFC: ${
      others.data.others?.NFC ? others.data.others?.NFC : "No NFC"
    }</h6>
    <h6 style="margin-bottom:-1px;">Radio: ${
      others.data.others?.Radio ? others.data.others?.Radio : "No Radio"
    }</h6>
    <h6 style="margin-bottom:-1px;">USB: ${
      others.data.others?.USB ? others.data.others?.USB : "No USB"
    }</h6>
    <h6 style="margin-bottom:-1px;">WLAN: ${
      others.data.others?.WLAN ? others.data.others?.WLAN : "No WLAN"
    }</h6>
    `;
